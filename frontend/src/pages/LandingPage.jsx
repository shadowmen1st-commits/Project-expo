...
const HowItWorksSection = () => {
    const { ref, visible } = useInView();
    return (
        <section id="how-it-works" className="py-24 px-6 bg-[#FEF3C7]/40 border-y border-[#FEF3C7]" ref={ref}>
            <div className="max-w-6xl mx-auto">
                <div className={`text-center mb-16 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <p className="text-[#F97316] text-sm font-semibold uppercase tracking-wider mb-3">Simple Process</p>
                    <h2 className="text-4xl md:text-5xl font-black text-[#111827] mb-4">Book in 4 Easy Steps</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
                    {STEPS.map((step) => {
                        const IconComponent = step.icon;
                        return (
                            <div key={step.n} className="relative bg-white border border-[#FEF3C7] hover:border-[#F97316]/50 rounded-2xl p-6 text-center group transition-all duration-300 shadow-sm hover:shadow-md">
                                <span className="absolute top-4 right-5 text-4xl font-extrabold text-[#FEF3C7] select-none">
                                    {step.n}
                                </span>
                                <div className="w-14 h-14 rounded-2xl bg-[#FFEDD5] text-[#F97316] border border-[#FED7AA] flex items-center justify-center mx-auto mb-5">
                                    <IconComponent className="w-6 h-6"/>
                                </div>
                                <h3 className="text-[#111827] font-bold mb-2 group-hover:text-[#F97316] transition-colors">{step.title}</h3>
...
const WorkersSection = ({ navigate }) => {
    return (
        <section id="for-workers" className="py-24 px-6">
            <div className="max-w-6xl mx-auto">
                <div className="bg-white border border-[#FEF3C7] rounded-3xl p-10 md:p-16 grid md:grid-cols-2 gap-12 items-center shadow-sm">
                    <div>
                        <p className="text-[#F97316] text-sm font-semibold uppercase tracking-wider mb-4">For Professionals</p>
                        <h2 className="text-4xl font-black text-[#111827] mb-5 leading-tight">
                            Turn Your Skills Into a <span className="text-[#F97316]">Thriving Career</span>
                        </h2>
                        <p className="text-[#4B5563] mb-8 leading-relaxed">Join 8,000+ verified workers earning steady income on their own schedule. Get paid weekly, track every rupee in your transparent wallet, and build your reputation with customer reviews.</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={s.label} className="bg-[#FFFBEB] border border-[#FEF3C7] rounded-2xl p-5 text-center">
...
export const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FFFBEB] text-[#111827] overflow-x-hidden font-sans">
            <SharedNavbar />
            ...
            {/* HERO */}
            <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-16 pb-12 bg-gradient-to-br from-[#FFFBEB] via-[#FEF08A]/15 to-[#FFEDD5]/20">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#FACC15]/20 rounded-full blur-[120px] pointer-events-none"/>

                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center animate-fade-in">
                    <div className="inline-flex items-center gap-2 bg-[#FFFBEB] border border-[#FED7AA] rounded-full px-4 py-1.5 text-xs font-semibold text-[#F97316] mb-8 shadow-sm">
                    ...
                    <p className="text-[#374151] text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-normal">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch gap-3 max-w-xl mx-auto mb-12">
                        <div className="flex-1 flex items-center gap-3 bg-white border border-[#FEF3C7] rounded-2xl px-4 py-3 focus-within:border-[#F97316] focus-within:ring-2 focus-within:ring-[#FACC15]/40 shadow-sm transition-all">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-[#4B5563]">
                        {['✓ Background Verified Workers', '✓ Secure Escrow Payments', '✓ Real-time Tracking', '✓ 30-day Service Guarantee'].map(t => (
                            <span key={t} className="bg-white/60 border border-[#FEF3C7] px-3 py-1 rounded-full">{t}</span>
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* STATS BAND */}
            <section className="border-y border-[#FEF3C7] bg-[#FEF3C7]/30 py-10">
                <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {STATS.map((s) => (
                        <div key={s.label} className="text-center">
                            <div className="text-3xl md:text-4xl font-black text-highlight-gradient mb-1">{s.value}</div>
                            <div className="text-[#4B5563] text-sm font-medium">{s.label}</div>
                        </div>
                    ))}
                </div>
            </section>
            ...
            {/* TESTIMONIALS */}
            <section className="py-24 px-6 bg-[#FEF3C7]/30 border-y border-[#FEF3C7]">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <p className="text-[#F97316] text-sm font-semibold uppercase tracking-wider mb-3">Reviews</p>
                        <h2 className="text-4xl font-black text-[#111827]">What People Say</h2>
                    </div>

                    <div className="bg-white border border-[#FEF3C7] rounded-3xl p-8 md:p-10 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <p className="text-[#111827] text-lg md:text-xl leading-relaxed mb-8 italic">
                            "{TESTIMONIALS[activeTestimonial].text}"
                        </p>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full logo-gradient flex items-center justify-center text-[#111827] font-bold text-sm shadow-sm">
                                {TESTIMONIALS[activeTestimonial].avatar}
                            </div>
                            <div>
                                <div className="text-[#111827] font-semibold">{TESTIMONIALS[activeTestimonial].name}</div>
                                <div className="text-[#4B5563] text-sm">{TESTIMONIALS[activeTestimonial].role} · {TESTIMONIALS[activeTestimonial].city}</div>
                            </div>
                        </div>
                    </div>
                </div>
