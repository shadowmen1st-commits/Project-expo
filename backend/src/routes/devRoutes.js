...
router.post('/seed-admin-data', async (req, res, next) => {
    try {
        console.log('Starting Admin Testing Data DB Seeding via API...');
        ...
        res.status(200).json({
            success: true,
            message: 'Admin Panel testing data seeded successfully!',
        });
    } catch (err) {
        next(err);
    }
...
router.post('/seed-admin-demo', async (req, res, next) => {
    try {
        console.log('Starting Full Admin Demo Data DB Seeding via API...');
        ...
        await AuditLog.deleteMany({ actor: admin._id });
        ...
        res.status(200).json({
            success: true,
            message: 'Admin Panel demo data seeded successfully!',
        });
    } catch (err) {
        next(err);
    }
